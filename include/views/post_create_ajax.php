...
if(!isset($_POST['get_postform'])){
    ...
    '<div class="container">
        <div class="formbox">
            ...
            <form class="form" id="form-post" name="form-post" onsubmit="checkPostInput();" method="POST" action="post_process_ajax.php" enctype="multipart/form-data">
